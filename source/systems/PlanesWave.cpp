...
void PlanesWave::spawnWave(void) {
    ...
    for (std::size_t i = 0; i < 4; i++) {
        spawnEntity(geg::component::Transform2D({x, y + randomY(gen)}, {2, 2}, 0),
                    ...
                    geg::component::io::Sprite("plane.gif", Rectangle{0, 0, 33, 36}, WHITE),
                    geg::component::io::Animation("plane.json/fly", 0.075f), geg::component::io::Drawable(1),
                    component::Plane(), component::Monster(), geg::component::HitBoxSquare2D(32, 36),
                    component::Score(100), geg::component::network::NetSend());
        x += 75;
    }
}
} // namespace rtype::system
