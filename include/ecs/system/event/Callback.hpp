...
namespace ecs::system::event {
    ...
    public:
         ...
         *
         * @param instance The instance of the class that contains the member function.
    ...
    private:
        T& m_instance; ///< Reference to the instance of the class containing the member function.
