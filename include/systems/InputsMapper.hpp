...
class InputBoxMapperHandler
    : public gengine::OnEventSystem<InputBoxMapperHandler, geg::event::io::KeyPressedEvent,
                                    geg::component::gui::SelectButton, component::InputBoxMapper,
                                    geg::component::io::Text, geg::component::Box<1>> {
public:
    void onEvent(geg::event::io::KeyPressedEvent &) final;
};

static const std::unordered_map<int, std::string> keyToString = {{KEY_NULL, "NULL"},
                                                                 {KEY_APOSTROPHE, "'"},
                                                                 {KEY_COMMA, ","},
                                                                 {KEY_MINUS, "-"},
                                                                 {KEY_PERIOD, "."},
