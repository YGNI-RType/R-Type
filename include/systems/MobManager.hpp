...
class MobManager : public gengine::System<MobManager, StageManager, component::Monster, geg::component::io::Sprite,
                                          geg::component::io::Animation, geg::component::io::Drawable,
                                          geg::component::HitBoxSquare2D, geg::component::Transform2D,
                                          geg::component::Velocity2D, geg::component::network::NetSend>,
...
public:
    ...
    void spawnMob(event::BossSpawnWave &);

    const std::vector<Mob> &getMob(const std::string &) const;
